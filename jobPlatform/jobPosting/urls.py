...
from jobPosting.views import userRegisteration, create_job_posting, upload_resumes, track_application, apply_job, search_job_listings
...
urlpatterns = [
    ...
    path('resume/', upload_resumes, name='upload_resumes')
]